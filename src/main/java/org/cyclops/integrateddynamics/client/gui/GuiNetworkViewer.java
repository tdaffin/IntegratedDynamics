...
/**
 * Gui for the {@link org.cyclops.integrateddynamics.item.ItemNetworkViewer}.
 */
public class GuiNetworkViewer extends ScrollingGuiContainer {
    ...
    @Override
    public ContainerNetworkViewer getContainer() {
        return (ContainerNetworkViewer) super.getContainer();
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        for(int i = 0; i < container.getPageSize(); i++) {
            if(container.isElementVisible(i)) {
            	NetworkElementGui element = container.getVisibleElement(i);
                ...
                boolean hover = //LogicProgrammerElementTypes.areEqual(container.getActiveElement(), element)
                		container.getActiveElement() == element
        ...
        /*if ( writeItemStack != null ) {
        	...
        	if ( tagCompound != null ) {
                ...
                for(int i = 0; i < container.getPageSize(); i++) {
                    ...
                    // Operator info
                    //String aspectName = element.getSymbol();
                    String aspectName = tagKeys.get(i);
                    RenderHelpers.drawScaledCenteredString(fontRenderer, aspectName,
                            this.guiLeft + offsetX + (hover ? 22 : 21),
                            this.guiTop + offsetY + 26 + boxHeight * i,
                            53, Helpers.RGBToInt(40, 40, 40));
        ...
        /*INetwork network =
            ...
            if (network != null) {
            	...
            	List<INetworkElement> elements = network.getElements().stream().collect(Collectors.toList());
                for(int i = 0; i < container.getPageSize(); i++) {
                	if (i >= elements.size())
                		break;
                    ...
                    // Operator info
                    //String aspectName = element.getSymbol();
                    String aspectName = element.getClass().getSimpleName();
                    RenderHelpers.drawScaledCenteredString(fontRenderer, aspectName,
                            this.guiLeft + offsetX + (hover ? 22 : 21),
                            this.guiTop + offsetY + 26 + boxHeight * i,
                            53, Helpers.RGBToInt(40, 40, 40));
    ...
    protected Rectangle getElementPosition(ContainerNetworkViewer container, int i, boolean absolute) {
    ...
    protected void onDeactivateElement(NetworkElementGui element) {
        subGuiHolder.clear();
    }

    public boolean handleElementActivation(NetworkElementGui element) {
        boolean activate = false;
        ContainerNetworkViewer container = (ContainerNetworkViewer) getScrollingInventoryContainer();
        NetworkElementGui newActive = null;
    ...
    public class SubGuiOperatorInfo extends GuiElementValueTypeString.SubGuiValueTypeInfo<RenderPattern, GuiNetworkViewer, ContainerNetworkViewer> {
        ...
        public SubGuiOperatorInfo(IGuiInputElement<RenderPattern, GuiNetworkViewer, ContainerNetworkViewer> element) {
            super(GuiNetworkViewer.this, (ContainerNetworkViewer) GuiNetworkViewer.this.container, element, 88, 106, 139, 20);
            ...
            int searchWidth = 113;
            this.searchField = new GuiTextFieldExtended(0, GuiNetworkViewer.this.fontRenderer, 0, 0, searchWidth, 11);
